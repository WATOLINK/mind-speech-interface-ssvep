...
class EEGSocketListener:
    ...
    def recieve_packet(self):
        ...
        if sample == None:
            ...
            assert type(
                sample) == np.ndarray,  f"Not a Numpy ND Array {type(sample), sample}"
...
def get_args(parser):
    ...
    parser.add_argument('--port', type=int, help='ip port',
                        required=False, default=65432)
    ...
    parser.add_argument('--model-type', type=str,
                        help='The type of model to use. i.e. CCA with KNN', default='cca_knn')
    parser.add_argument('--model-path', type=str,
                        help='The filepath to the model to use')
...
if __name__ == '__main__':
    ...
    listener = EEGSocketListener(args.host, args.port, args.num_channels,
                                 args.input_len, args.output_size, args.model_type, args.model_path)
