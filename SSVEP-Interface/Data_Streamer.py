...
def get_args(parser):
    ...
    parser.add_argument('--input-len', type=int, help='input size', required=False, default=125)
    ...
    parser.add_argument('--window-length', type=float, help='window size (s)', required=False, default=4.0)
