...
class Preprocess:
    ...
    def __init__(self, data, num_timesteps = 1114, num_channels = 8, sample_freq = 250, num_frequencies = 13):
    ...
    def _forward_fill(self, data):
        ...
        #print("VALUE FORWARD COUNTS")
       # print(filled_data['Frequency'].value_counts())
    ...
    def _put_together(self, all_data):
        ...
        t = together_finally.reshape(self.num_frequencies, 1114, 8, 5)
    ...
    def put_together(self, df1, df2):
        ...
        t = together_finally.reshape(self.num_frequencies, 1114, 8, 2)
        t = np.transpose(t, (0,2,1,3))
